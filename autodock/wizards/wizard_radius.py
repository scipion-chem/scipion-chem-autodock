...
from ..protocols import Autodock_GridGeneration, ProtChemAutodock, ProtChemAutoLigand, ProtChemVina

for prot in [Autodock_GridGeneration, ProtChemAutodock, ProtChemVina, ProtChemAutoLigand]:
